...
//   if (distance < 4) {
//     dustbinStatus = "Full"; // If distance less than 10cm, consider it full
//   } else {
//     dustbinStatus = "Empty"; // If distance greater than or equal to 10cm, consider it empty
//   }

//   return dustbinStatus;
// }

// void sendDataToDjango(float distance, String status) {
//   WiFiClient client;
//   HTTPClient http;
...
//     String jsonData = "{\"distance\": " + String(distance) + ", \"status\": \"" + status + "\"}";
...
//   sendDataToDjango(distance, status);
