...
urlpatterns = [
    ...
    path("blog_post5/", views.blog_post5, name="blog_post5"),
    path("blog_post6/", views.blog_post6, name="blog_post6"),
    path("blog_post7/", views.blog_post7, name="blog_post7"),
    path("blog_post8/", views.blog_post8, name="blog_post8"),
